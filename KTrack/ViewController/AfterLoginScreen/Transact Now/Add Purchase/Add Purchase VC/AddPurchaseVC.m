...
@interface AddPurchaseVC ()<UIScrollViewDelegate,UIPickerViewDelegate,UIPickerViewDataSource,UITextFieldDelegate>{
    ...
    __weak IBOutlet NSLayoutConstraint *cont_subcat;//65
...
//
//        lbl_miniAmount.text = [NSString stringWithFormat:@"%@",schemmeDic.minAmt];
//
//        miniAmount=[NSString stringWithFormat:@"%@",schemmeDic.minAmt];
//        str_plan =[NSString stringWithFormat:@"%@",schemmeDic.pln];;
//
...
//        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(12, 0, txt_Scheme.frame.size.width-35,  txt_Scheme.frame.size.height)];
//        label.text =txt_Scheme.text;
//        label.numberOfLines =2;
//        [label setFont:[UIFont boldSystemFontOfSize:14]];
//       [ txt_Scheme addSubview:label];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    CGRect frame = CGRectMake(10,10,self.view.frame.size.width,80);
...
-(void)paymentModeApi{
    ...
    NSString *str_fundss =[XTAPP_DELEGATE convertToBase64StrForAGivenString:str_selectedFundID];
    NSString *str_folioss=[XTAPP_DELEGATE convertToBase64StrForAGivenString:selectedPan];
    NSString *str_plntype =[XTAPP_DELEGATE convertToBase64StrForAGivenString:@""];
    NSString *str_url = [NSString stringWithFormat:@"%@getMasterNewpur?Adminusername=c21hcnRzZXJ2aWNl&Adminpassword=a2FydnkxMjM0JTI0&IMEI=%@&OS=%@&APKVer=%@&opt=%@&fund=%@&schemetype=%@&plntype=%@",KTBaseurl,unique_UDID,str_operatingSystem,str_appVersion,str_otpType,str_fundss,str_folioss,str_plntype];
...
-(void)purchaseurl{
    ...
    //    p.setParam("Otp", "");
    //    p.setParam("trtype", "");
    //    p.setParam("PanNo", enc_PAN);
    //    p.setParam("Desci", enc_Desc);
    //    p.setParam("IMEINO", enc_IMEI);
    //    p.setParam("Bankid", enc_BankId);
    //    p.setParam("upiid", enc_upiID);
    //    p.setParam("paymenttype", enc_paymode_value);
    //
    //    p.setParam("nom1", "");
    //    p.setParam("nom2", "");
    //    p.setParam("nom3", "");
